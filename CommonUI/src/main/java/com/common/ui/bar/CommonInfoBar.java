...
public class CommonInfoBar extends LinearLayout {
    ...
    public void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        //title
        mStyleControl.mTitleGravity = a.getInt(R.styleable.CommonInfoBar_common_infobar_title_gravity, CommonInfoBarStyleControl.TITLE_GRAVITY_CENTER);
        ...
        mStyleControl.mTitleWidth = a.getDimensionPixelSize(R.styleable.CommonInfoBar_common_infobar_title_label_width, DeviceUtil.getPixelFromDip(getContext(),100));

        //value
        mStyleControl.mValueGravity = a.getInt(R.styleable.CommonInfoBar_common_infobar_value_gravity, CommonInfoBarStyleControl.TITLE_GRAVITY_CENTER);
    ...
    protected void initView() {
        ...
        if (mStyleControl.mHasArrow) {
            if (mStyleControl.mArrowDrawable != null) {
                mIconView.setImageDrawable(mStyleControl.mArrowDrawable);
            } else {
